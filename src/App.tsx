...
function App() {
  ...
  return (
    <ErrorBoundary>
      <IconThemeProvider defaultTheme="default">
        <TooltipProvider>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button 
                          ...
                          className={`text-muted-foreground hover:text-primary ${
                            showIconThemeSelector ? 'text-primary bg-primary/10' : ''
                          }`}
                      ...
                      <TooltipContent>
                        <p>Icon Theme Selector {showIconThemeSelector ? '(Active)' : ''}</p>
                      </TooltipContent>
                    </Tooltip>
